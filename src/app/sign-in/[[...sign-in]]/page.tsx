    ...
    return (
      <main className="flex min-h-screen flex-col items-center justify-center bg-[#0a0b10] text-slate-200 p-4">
        <div className="p-8 rounded-xl bg-slate-900 border border-slate-800 text-center max-w-md shadow-2xl">
          <div className="w-12 h-12 rounded-xl bg-indigo-500/20 border border-indigo-500/30 mx-auto mb-4 flex items-center justify-center text-indigo-400 font-bold text-xl">
            NF
          </div>
          <h1 className="text-xl font-semibold mb-2">NextFlow Dev Mode</h1>
          <p className="text-sm text-slate-400 mb-6">Clerk publishable key is not configured. You are automatically signed in as Nexus Developer.</p>
